                    ...
                    <form class="form-horizontal" action="{{ route('shops.update', $shop) }}" method="post" enctype="multipart/form-data">
                        ...
                        @if (! request()->exists('narrow'))
                            ...
                            <div class="form-group {{ $errors->has('phone') ? ' has-error' : '' }}">
                                <label class="control-label col-sm-3" for="phone">Shop phone</label>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                                <label class="control-label col-sm-3" for="email">Shop email</label>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group {{ $errors->has('address') ? ' has-error' : '' }}">
                                <label class="control-label col-sm-3" for="address">Shop address</label>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group {{ $errors->has('contact') ? ' has-error' : '' }}">
                                <label class="control-label col-sm-3" for="contact">Contact name</label>
                                <div class="col-sm-4">
